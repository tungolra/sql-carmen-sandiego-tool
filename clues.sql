...
-- Write SQL query here
    SELECT * FROM country WHERE region LIKE 'Southern Europe'
...
-- Write SQL query here
SELECT country.capital, city.name AS "CityName", country.name AS "CountryName", city.population
    FROM country JOIN city 
    ON city.id = country.capital WHERE
    country.name = 'Brazil';
